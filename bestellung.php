...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') { header('Location: bestellung.html'); exit; }
...
if (!$errors) {
  ...
  $subject = 'HOGAsports Bestellanfrage: ' . $produkt;
  $body = "Neue Bestellanfrage über hogasports.de\n\n".
...
?>
<!doctype html><html lang="de"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Bestellanfrage | HOGAsports</title><link rel="stylesheet" href="assets/css/style.css"></head><body><main class="section"><div class="container"><div class="form-card" style="text-align:center;max-width:720px"><img src="assets/img/hogasports-logo.png" alt="HOGAsports" style="width:220px;margin:0 auto 28px"><?php if($sent): ?><div class="success"><strong>Vielen Dank!</strong><br>Ihre Bestellanfrage wurde an HOGAsports gesendet. Wir melden uns bei Ihnen.</div><a class="btn btn-primary" href="index.html">Zurück zur Startseite</a><?php else: ?><div class="error"><strong>Die Anfrage konnte nicht gesendet werden.</strong><br><?php echo implode('<br>', array_map('esc',$errors)); ?></div><a class="btn btn-secondary" href="bestellung.html">Zurück zum Formular</a> <a class="btn btn-primary" href="mailto:info@hogasports.de">E-Mail schreiben</a><?php endif; ?></div></div></main></body></html>
